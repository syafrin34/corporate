...
func (a *aboutCompanyService) FetchAllCompanyAndKeynote(ctx context.Context) (*entity.AboutCompanyEntity, error) {
	return a.aboutCompanyRepo.FetchAllCompanyAndKeynote(ctx)
}
